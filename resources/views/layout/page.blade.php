  ...
  <header>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right ">
        ...
        <li><a href="{{url('/currentstudents')}}">Current Students</a></li>
...
<div class="row fix">
  ...
  <div class="col-md-6">
    ...
    <div class="item active1">
      ...
      <img src="image/Wikimedia-logo.png" alt="caption">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="{{url('/principalsmessage')}}">Principal's Message</a></li>
